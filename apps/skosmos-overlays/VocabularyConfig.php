...
class VocabularyConfig extends BaseConfig
{
    ...
    /**
     * Returns extra RDF properties that should be included in concept search.
     * Configured with skosmos:searchProperty (e.g. xkos:inclusionNote).
     * @return string[] property names, preferably shortened (e.g. 'xkos:inclusionNote')
     */
    public function getSearchProperties()
    {
        $resources = $this->resource->allResources("skosmos:searchProperty");
        $ret = array();
        foreach ($resources as $res) {
            $prop = $res->getURI();
